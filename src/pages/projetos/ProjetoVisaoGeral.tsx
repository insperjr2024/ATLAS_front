...
import { ROTULO_STATUS_BANCA, toDateInputValue, toTimeInputValue, tomDoStatusBanca } from "@/lib/bancas";
...
function MarcarBancaModal({
  ...
  const [dataHora, setDataHora] = useState(
    escopo.banca?.data_hora
      ? `${toDateInputValue(escopo.banca.data_hora)}T${toTimeInputValue(escopo.banca.data_hora)}`
      : "",
  );
